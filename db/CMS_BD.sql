...
CREATE TABLE IF NOT EXISTS `cidade` (
	...
	CONSTRAINT FOREIGN KEY(`estado`) REFERENCES `estado`(id),
	PRIMARY KEY(id))
	ENGINE = InnoDB
	DEFAULT CHARSET = utf8;


create table if not exists ModoUsuario(
...
CREATE TABLE IF NOT EXISTS `mydb`.`Pessoa` (
  ...
  constraint foreign key(estadoCivil) references EstadoCivil(id),
  PRIMARY KEY (`cpf`))
ENGINE = InnoDB;
...
create table if not exists Usuario(
    ...
    `data`date not null,
    Pessoa_cpfPessoa varchar(45),
    `modoUsuario` int not null,
    constraint foreign key(modoUsuario) references ModoUsuario(id),
    constraint foreign key(Pessoa_cpfPessoa) references Pessoa(cpf),
	primary key(login))
    ENGINE = INNODB;
...
create table if not exists Acesso(
    ...
    logout datetime,
    CONSTRAINT FOREIGN KEY(Usuario_login) REFERENCES Usuario(login),
    PRIMARY KEY(id))
    ENGINE = InnoDB;
...
create table if not exists Acesso_Alteracao(
	id int auto_increment,
    Acesso_id int not null,
    Alteracao_id int not null,
    dataAlteracao date not null,
    CONSTRAINT FOREIGN KEY(Acesso_id) REFERENCES Acesso(id),
    CONSTRAINT FOREIGN KEY(Alteracao_id) REFERENCES Alteracao(id),
    PRIMARY KEY(id))
    ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Membros` (
  ...
  `Pessoa_cpfPessoa` varchar(45) not null,
  `email` VARCHAR(45) NOT NULL,
  `telefone` VARCHAR(45) NOT NULL,
  `dataRegistro` date,
  `foto` VARCHAR(120) NOT NULL,
  `dataBatismo` Date,
  `numDependentes` int not null,
  `desligado`int not null,
  `cargo`int not null,
  `disciplinado`int not null,
  `usuario`int not null,
  constraint foreign key(cargo) references Cargos(idCargo),
  PRIMARY KEY (`idMembro`),
  INDEX `fk_Membros_Pessoa_idx` (`Pessoa_cpfPessoa` ASC),
  CONSTRAINT `fk_Membros_Pessoa`
    FOREIGN KEY (`Pessoa_cpfPessoa`)
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Consagração` ;

CREATE TABLE IF NOT EXISTS `mydb`.`Consagração` (
  `idConsagração` INT NOT NULL auto_increment,
  `dsc` VARCHAR(45) NOT NULL,
  `Cargos_idCargo` INT NOT NULL,
  `Pessoa_cpfPessoa` Varchar(45) not null,
  `data` date not null,
  PRIMARY KEY (`idConsagração`),
  INDEX `fk_Titulo_Cargos1_idx` (`Cargos_idCargo` ASC) ,
  INDEX `fk_Titulo_Membros1_idx` (`Pessoa_cpfPessoa` ASC) ,
  CONSTRAINT `fk_Titulo_Cargos1`
    FOREIGN KEY (`Cargos_idCargo`)
    REFERENCES `mydb`.`Cargos` (`idCargo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Titulo_Membros1`
    FOREIGN KEY (`Pessoa_cpfPessoa`)
    REFERENCES `mydb`.`Pessoa` (`cpf`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- Table `mydb`.`Dizimos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Dizimos` ;

CREATE TABLE IF NOT EXISTS `mydb`.`Dizimos` (
  `idDizimos` INT auto_increment,
  `Pessoa_cpfPessoa` vARCHAR(45) NOT NULL,
  `valor` INT NOT NULL,
  `data` date not null,
  PRIMARY KEY (`idDizimos`),
  constraint foreign key(Pessoa_cpfPessoa) references Pessoa(cpf)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Desligamentos` ;

CREATE TABLE IF NOT EXISTS `mydb`.`Desligamentos` (
  `idDesligamentos` INT NOT NULL auto_increment,
  `Pessoa_cpfPessoa` Varchar(45) not null,
  `data` date not null,
  `dsc` VARCHAR(90) NOT NULL,
  PRIMARY KEY (`idDesligamentos`),
  INDEX `fk_Desligamentos_Membros1_idx` (`Pessoa_cpfPessoa` ASC) ,
  CONSTRAINT `fk_Desligamentos_Membros1`
    FOREIGN KEY (`Pessoa_cpfPessoa`)
    REFERENCES `mydb`.`Pessoa` (`cpf`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `mydb`.`Disciplina` (
  ...
  INDEX `fk_Disciplina_Membros1_idx` (`Pessoa_cpfPessoa` ASC) ,
  CONSTRAINT `fk_Disciplina_Membros1`
    FOREIGN KEY (`Pessoa_cpfPessoa`)
    REFERENCES `mydb`.`Pessoa` (`cpf`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- Table `mydb`.`Ofertas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Ofertas` ;

CREATE TABLE IF NOT EXISTS `mydb`.`Ofertas` (
  `idOfertas` int auto_increment,
  `valor` Double NOT NULL,
  `data` date not null,
  `dsc` VARCHAR(45) NOT NULL,
  `Setores_idSetores`Int not null,
  constraint foreign key(Setores_idSetores) references Setores(idSetores),
  PRIMARY KEY (`idOfertas`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `mydb`.`Renda Mensal`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Renda Mensal` ;

CREATE TABLE IF NOT EXISTS `mydb`.`Renda Mensal` (
  `mes` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`Renda Anual`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Renda Anual` ;

CREATE TABLE IF NOT EXISTS `mydb`.`Renda Anual` (
  `ano` INT NOT NULL,
  `valor` VARCHAR(45) NOT NULL,
  `data` date not null,
  PRIMARY KEY (`ano`))
...
-- Table `mydb`.`Caixas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Caixas` ;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Caixas` (
  ...
  `data` date not null,
  INDEX `fk_Caixa_Setores1_idx` (`Setores_idSetores` ASC) ,
  PRIMARY KEY (`idCaixa`),
  CONSTRAINT `fk_Caixa_Setores1`
...
-- Table `mydb`.`Retiro`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Retiro` ;

CREATE TABLE IF NOT EXISTS `mydb`.`Retiro` (
...
-- -----------------------------------------------------
-- Table `mydb`.`Membros_Retiro`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Membros_Retiro` ;

CREATE TABLE IF NOT EXISTS `mydb`.`Membros_Retiro` (
  `Membros_idMembros` INT NOT NULL,
  `Retiro_idRetiros` INT NOT NULL,
  `idMembroRetiro` INT NOT NULL,
  INDEX `fk_Membros_Retiro_Membros1_idx` (`Membros_idMembros` ASC) ,
  INDEX `fk_Membros_Retiro_Retiro1_idx` (`Retiro_idRetiros` ASC) ,
  PRIMARY KEY (`idMembroRetiro`),
  CONSTRAINT `fk_Membros_Retiro_Membros1`
    FOREIGN KEY (`Membros_idMembros`)
    REFERENCES `mydb`.`Membros` (`idMembro`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Membros_Retiro_Retiro1`
    FOREIGN KEY (`Retiro_idRetiros`)
    REFERENCES `mydb`.`Retiro` (`idRetiros`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`Fatura_retiro`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Fatura_retiro` ;

CREATE TABLE IF NOT EXISTS `mydb`.`Fatura_retiro` (
  `idFatura_retiro` INT NOT NULL,
  `numParcelas` VARCHAR(45) NOT NULL,
  `numPagas` VARCHAR(45) NOT NULL,
  `numInadimplente` VARCHAR(45) NOT NULL,
  `Retiro_idRetiros` INT NOT NULL,
  `Membros_Retiro_idMembroRetiro` INT NOT NULL,
  PRIMARY KEY (`idFatura_retiro`),
  INDEX `fk_Fatura_retiro_Retiro1_idx` (`Retiro_idRetiros` ASC) ,
  INDEX `fk_Fatura_retiro_Membros_Retiro1_idx` (`Membros_Retiro_idMembroRetiro` ASC) ,
  CONSTRAINT `fk_Fatura_retiro_Retiro1`
    FOREIGN KEY (`Retiro_idRetiros`)
    REFERENCES `mydb`.`Retiro` (`idRetiros`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Fatura_retiro_Membros_Retiro1`
    FOREIGN KEY (`Membros_Retiro_idMembroRetiro`)
    REFERENCES `mydb`.`Membros_Retiro` (`idMembroRetiro`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
/* Valores Padrões*/
/*ESTADO CIVIL*/
INSERT INTO EstadoCivil(dsc) VALUES("Solteiro(a)");
INSERT INTO EstadoCivil(dsc) VALUES("Casado(a)");
INSERT INTO EstadoCivil(dsc) VALUES("Divorciado(a)");
INSERT INTO EstadoCivil(dsc) VALUES("Viúvo(a)");


/*----------------*/
/*CARGOS*/
INSERT INTO Cargos(dsc) VALUES("Membro");
INSERT INTO Cargos(dsc) VALUES("Cooperador");
INSERT INTO Cargos(dsc) VALUES("Diacono");
INSERT INTO Cargos(dsc) VALUES("Presbítero");
INSERT INTO Cargos(dsc) VALUES("Evangelista");
INSERT INTO Cargos(dsc) VALUES("Pastor");
/*--------------------------*/

/*-------------------*/
/*Caixa Principal*/
INSERT INTO Setores(nome,foto,dsc,data) VALUES("Igreja","","",curdate());
INSERT INTO Caixas(dsc,receita,data,Setores_idSetores) VALUES("",0,curdate(),1);

/*************************/
INSERT INTO ModoUsuario(dsc) VALUES("User");
INSERT INTO ModoUsuario(dsc) VALUES("Admin");
/* --------------------- */
INSERT INTO Usuario(login,senha,modoUsuario,data) VALUES("admin","admin",2,curdate());
/***********************/
INSERT INTO Alteracao(dsc) VALUES("Cadastro de Membro");
INSERT INTO Alteracao(dsc) VALUES("Alteração de Membro");
INSERT INTO Alteracao(dsc) VALUES("Cadastro de Usuario");
INSERT INTO Alteracao(dsc) VALUES("Alteração de Usuario");
INSERT INTO Alteracao(dsc) VALUES("Cadastro de Disciplina");
INSERT INTO Alteracao(dsc) VALUES("Alteração de Disciplina");
INSERT INTO Alteracao(dsc) VALUES("Cadastro de Consagração");
INSERT INTO Alteracao(dsc) VALUES("Alteração de Consagração");
INSERT INTO Alteracao(dsc) VALUES("Cadastro de Desligamento");
INSERT INTO Alteracao(dsc) VALUES("Alteração de Desligamento");
INSERT INTO Alteracao(dsc) VALUES("Cadastro de Caixa");
INSERT INTO Alteracao(dsc) VALUES("Cadastro de Despesa");
INSERT INTO Alteracao(dsc) VALUES("Cadastro de Oferta");
INSERT INTO Alteracao(dsc) VALUES("Cadastro de Setor");
INSERT INTO Alteracao(dsc) VALUES("Cadastro de Dizimo");/*15*/

INSERT INTO Alteracao(dsc) VALUES("Relatorio de Membros");
INSERT INTO Alteracao(dsc) VALUES("Relatorio de Desligamentos");
INSERT INTO Alteracao(dsc) VALUES("Relatorio de Consagracoes");
INSERT INTO Alteracao(dsc) VALUES("Relatorio de Disciplinas");
INSERT INTO Alteracao(dsc) VALUES("Relatorio de Caixas");
INSERT INTO Alteracao(dsc) VALUES("Relatorio de Dizimos");
INSERT INTO Alteracao(dsc) VALUES("Relatorio de Despesas");
INSERT INTO Alteracao(dsc) VALUES("Relatorio de Ofertas");
INSERT INTO Alteracao(dsc) VALUES("Relatorio de Usuarios");
/*---------------------ESTADOS-------------*/
